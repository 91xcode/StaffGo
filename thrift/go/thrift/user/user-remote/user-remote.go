...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  UserInfo GetUser(i64 id)")
  fmt.Fprintln(os.Stderr, "  string GetName(i64 id)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "GetName":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetName requires 1 args")
      flag.Usage()
    }
    ...
    value0 := argvalue0
    fmt.Print(client.GetName(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
