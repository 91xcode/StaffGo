...
func NewTwoManagerImpl() *TwoManagerImpl{
	return &TwoManagerImpl{
		Keys: map[int]*Info{
			NUMBER1:{
				Category:"Girl",
				Types:"Girl",
...
func(v *TwoManagerImpl)GetList(number,page,count int)(model.Response, error){
