...
var file_user_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x83, 0x02, 0x0a, 0x04,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77,
	0x12, 0x15, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77,
	...
	0x00, 0x12, 0x3b, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x15, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x71,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*UserViewRequest)(nil),    // 3: user.UserViewRequest
	(*UserViewResponse)(nil),   // 4: user.UserViewResponse
	(*UserPostRequest)(nil),    // 5: user.UserPostRequest
	(*UserPostResponse)(nil),   // 6: user.UserPostResponse
	(*UserDeleteRequest)(nil),  // 7: user.UserDeleteRequest
	(*UserDeleteResponse)(nil), // 8: user.UserDeleteResponse
}
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserIndexResponse.data:type_name -> user.UserEntity
	0, // 1: user.UserViewResponse.data:type_name -> user.UserEntity
	1, // 2: user.User.UserIndex:input_type -> user.UserIndexRequest
	3, // 3: user.User.UserView:input_type -> user.UserViewRequest
	5, // 4: user.User.UserPost:input_type -> user.UserPostRequest
	7, // 5: user.User.UserDelete:input_type -> user.UserDeleteRequest
	2, // 6: user.User.UserIndex:output_type -> user.UserIndexResponse
	4, // 7: user.User.UserView:output_type -> user.UserViewResponse
	6, // 8: user.User.UserPost:output_type -> user.UserPostResponse
	8, // 9: user.User.UserDelete:output_type -> user.UserDeleteResponse
